package MarioSDK.sprites;

import java.awt.Graphics;

import MarioSDK.component.Sprite;
import MarioSDK.effects.Death;
import MarioSDK.effects.Squish;
...
public class Enemy extends Sprite {
    ...
    public Enemy(boolean visuals, float x, float y, int dir, SpriteType type) {
        ...
        if (visuals) {
            this.graphics = new Images(Assets.enemies, this.type.getStartIndex());
            this.graphics.originX = 8;
            this.graphics.originY = 31;
            this.graphics.width = 16;

            this.wingGraphics = new Images(Assets.enemies, 32);
                    ...
                    if (winged) {
                        ...
                        if (type == SpriteType.GREEN_KOOPA || type == SpriteType.GREEN_KOOPA_WINGED) {
                            ...
                            if (this.graphics != null) {
                                this.world.addEffect(new Squish(this.x, this.y - 7));
                            }
                        }
            ...
            if (yD > -height && yD < shell.height) {
                ...
                if (this.graphics != null) {
                    if (this.type == SpriteType.GREEN_KOOPA || this.type == SpriteType.GREEN_KOOPA_WINGED) {
                        this.world.addEffect(new Death(this.x, this.y, this.graphics.flipX, 42, -5));
                    } else if (this.type == SpriteType.RED_KOOPA || this.type == SpriteType.RED_KOOPA_WINGED) {
                        this.world.addEffect(new Death(this.x, this.y, this.graphics.flipX, 41, -5));
                    } else if (this.type == SpriteType.GOOMBA || this.type == SpriteType.GOOMBA_WINGED) {
                        this.world.addEffect(new Death(this.x, this.y, this.graphics.flipX, 44, -5));
                    } else if (this.type == SpriteType.SPIKY || this.type == SpriteType.SPIKY_WINGED) {
                        this.world.addEffect(new Death(this.x, this.y, this.graphics.flipX, 45, -5));
                    }
                }
                this.world.removeSprite(this);
                return true;
