...
import MarioSDK.graphics.Tilemap;
...
public class Level {
    ...
    public int width = GamePlay.getWidth();
    public int tileWidth = GamePlay.getWidth() / 16;
    public int height = GamePlay.getHeight();
    public int tileHeight = GamePlay.getHeight() / 16;
    ...
    private Tilemap graphics;
    private Images flag;

    public Level(String level, boolean visuals) {
        ...
        if (visuals) {
            this.graphics = new Tilemap(Assets.level, this.levelTiles);
            this.flag = new Images(Assets.level, 41);
            this.flag.width = 16;
            this.flag.height = 16;
        }
    }
    ...
    public void render(Graphics og, int cameraX, int cameraY) {
        ...
        if (cameraX + GamePlay.getWidth() >= this.exitTileX * 16) {
