...
public class BulletBill extends Sprite {
    ...
    public BulletBill(boolean visuals, float x, float y, int dir) {
        ...
        if (visuals) {
            this.graphics = new Images(Assets.enemies, 40);
        ...
        if (xMarioD > -16 && xMarioD < 16) {
            if (yMarioD > -height && yMarioD < world.mario.height) {
                if (world.mario.ya > 0 && yMarioD <= 0 && (!world.mario.onGround || !world.mario.wasOnGround)) {
                    ...
                    if (this.graphics != null) {
                        this.world.addEffect(new Death(this.x, this.y - 7, this.graphics.flipX, 43, 0));
                    }
    ...
    public boolean shellCollideCheck(Shell shell) {
        ...
        if (xD > -16 && xD < 16) {
            if (yD > -height && yD < shell.height) {
                if (this.graphics != null) {
                    this.world.addEffect(new Death(this.x, this.y - 7, this.graphics.flipX, 43, -1));
                }
